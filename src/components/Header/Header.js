...
function Header({onAddPlace, isMenuOpen,  onMenu, closeMenu, handleSearch, setSearch, loggedIn, auth, handleLoading }) {
    return (
        <header className="header">
            <Navigation onAddPlace={onAddPlace} closeMenu={closeMenu} isMenuOpen={isMenuOpen} onMenu={onMenu} loggedIn={loggedIn} auth={auth}/>
